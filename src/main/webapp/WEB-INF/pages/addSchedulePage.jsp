    ...
    <div class="wrapper_center">
        <div id="" class="wrap wrapper-flex">
            <div id="search_menu" class="left_menu type_black">
                <div>
                    <div class="title"><spring:message code="addTrainToSchedule"/></div>
                    ...
                    <button class="btn btn_blue" id="add_train_to_schedule" type="submit" disabled="true"><spring:message code="addTrainToScheduleBtn"/></button>
                </div>
            </div>
            <div class="content content_type-schedule">
                <div id="schedule" class="items">
